...
'---- 드라이브 관련 상수값 ----
Const Unknown = 0 'Drive type can't be determined.
Const Removable = 1 'Drive has removable media
Const Fixed = 2 'Drive has fixed (nonremovable) media
Const Remote = 3 'Network drives
Const CDROM = 4 'Drive is a CD-ROM
Const RAMDisk = 5 

'---- CDO2000메일링을 위한 상수값 ----
'CdoPostUsing Enum
const cdoSendUsingPickup = 1    'Send message using the local SMTP service pickupdirectory.
const cdoSendUsingPort = 2    'Send the message using the network (SMTP over the network).

'CdoProtocolsSuthentication Enum
