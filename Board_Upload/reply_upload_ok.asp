...
Page = req(theForm("Page"))
SearchOpt = req(theForm("SearchOpt"))
SearchVal = req(theForm("SearchVal"))
ref = req(theForm("ref"))
re_step = req(theForm("re_step"))
re_lvl = req(theForm("re_lvl"))
...
if Split(referer,"?")(0)<>"http://localhost/reply_upload.asp" then 
...
With oCmd
	...
	.CommandText = "dbo.sp_board_reply_upload"
